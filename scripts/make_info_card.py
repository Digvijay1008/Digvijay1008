...
ROWS = [
    ("host",),
    ("kv", "Now", "Software Developer"),
    ("kv", "Also", "AI Enthusiast"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Python, TypeScript, HTML/CSS"),
    ("kv", "Fields", "Web Development, AI/ML"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Building AI Leadmate & Nashik Kumbh Guide"),
